...
const ICONS = {
  ...
  overtime:
    "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Zm0-6v-4l3 1.5",
  notification:
  ...
  drugs:
    "M10.5 20H4a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h3.93a2 2 0 0 1 1.66.9l.82 1.2a2 2 0 0 0 1.66.9H20a2 2 0 0 1 2 2v2.5M12 11v6M9 14h6",
  equipment:
    "M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76Z",
  opportunity:
    "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm4.5 4.5-9 9M8.5 8.5h7v7",
  ...
  hospital:
    "M3 21h18M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16M9 21v-4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v4M10 9h4M12 7v4",
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`sidebar ${isAdmin ? "sidebar-admin" : ""} ${isOpen ? "sidebar-open" : ""}`}
      >
        {/* Brand */}
