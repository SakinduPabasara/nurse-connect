...
export default function TransferPage() {
  ...
  const fetchTransfers = useCallback(async (silent = false) => {
    ...
    try {
      const [myRes, matchRes] = await Promise.all([
        API.get("/transfers/my"),
        API.get("/transfers/matches"),
      ]);
      setTransfers(myRes.data);
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.desiredHospital || !form.desiredWard || !form.transferTimeframe) {
      setMsg({ type: "error", text: "Mandatory fields missing." });
      return;
    }
    setSubmitting(true);
    try {
      ...
      <div className="page-header">
        <div>
          ...
          <div className="page-subtitle">
            Coordinate inter-hospital mobility and mutual staffing exchanges
          </div>
        </div>
        ...
        >
          <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ fontSize: "0.78rem", color: "var(--text3)" }}>
              Register your inter-hospital mobility preference for HR matching
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: "grid", gap: 24 }}>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <SearchableSelect
                    ...
                    onChange={(val) =>
                      setForm({ ...form, currentHospital: val })
                    }
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <SearchableSelect
                    ...
                    onChange={(val) =>
                      setForm({ ...form, desiredHospital: val })
                    }
                    placeholder="Select hospital..."
                  />
                </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  ...
                  type="month"
                  value={form.transferTimeframe}
                  onChange={(e) =>
                    setForm({ ...form, transferTimeframe: e.target.value })
                  }
                />
              </div>
              <div className="form-group">
            ...
            <button
              ...
              style={{ padding: "14px", borderRadius: 14, fontSize: "0.92rem" }}
              type="submit"
              disabled={submitting}
            >
              {submitting ? (
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    tab === t.id
                      ? `0 6px 20px ${t.highlight ? "rgba(6,182,212,0.2)" : "rgba(37,99,235,0.3)"}`
                      : "none",
                }}
              >
                {t.label}
            ...
            <div className="empty-state">
              ...
              <div className="empty-state-text">
                {tab === "my"
                  ...
                  : "Monitoring for mutual matches..."}
              </div>
              <div className="empty-state-sub">
                {tab === "my"
                  ? "Use the button above to register a transfer intent"
                  : "Matches appear when another nurse requests the same exchange"}
              </div>
            </div>
          ) : (
                        ...
                        >
                          <div
                            style={{
                              ...
                              borderRadius: 12,
                              background:
                                "linear-gradient(135deg, rgba(6,182,212,0.2), rgba(99,102,241,0.15))",
